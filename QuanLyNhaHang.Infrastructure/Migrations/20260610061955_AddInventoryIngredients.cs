...
{
    /// <inheritdoc />
    public partial class AddInventoryIngredients : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IngredientCode = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IngredientCategories_IsActive",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ingredients_IngredientCategoryId_IsActive",
                table: "Ingredients",
                columns: new[] { "IngredientCategoryId", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_Ingredients_IngredientCode",
                table: "Ingredients",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryTransactions_IngredientId_TransactionType_Status",
                table: "InventoryTransactions",
                columns: new[] { "IngredientId", "TransactionType", "Status" });
