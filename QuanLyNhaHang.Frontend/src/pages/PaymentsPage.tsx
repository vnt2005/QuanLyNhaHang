...
export default function PaymentsPage() {
  ...
  function changeOrder(orderId: string) {
    ...
    setForm(current => ({
      ...
      issueInvoice: order?.orderType !== 'Takeaway',
    }))
  }
