  ...
  return (
    <div className="relative" ref={rootRef}>
      ...
      {toast && typeof document !== 'undefined' ? createPortal(
        <aside className="fixed bottom-5 right-5 z-[100] grid w-[min(400px,calc(100vw-32px))] grid-cols-[1fr_auto] border border-border bg-background shadow-[0_18px_60px_rgba(36,31,27,.18)]" role="status">
